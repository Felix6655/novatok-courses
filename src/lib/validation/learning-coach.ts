...
export const learningCoachRequestSchema = z.object({
  ...
  /** Optional recent Tutor Q&A from the active session â€” context only, never authoritative. */
...
/**
 * The model contributes explanation text only â€” never a lesson/course
 ...
 * is likewise just prose â€” which lessons actually need review is decided
