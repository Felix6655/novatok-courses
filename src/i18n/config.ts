...
export const LANGUAGE_INSTRUCTIONS: Record<Locale, string> = { en: "Respond in English.", es: "Responde en español.", pt: "Responda em português.", fr: "Répondez en français.", de: "Antworte auf Deutsch." };
